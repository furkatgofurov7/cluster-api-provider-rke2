...
push-prime-rke2-bootstrap-image: ## Build and push bootstrap prime image
	$(MAKE) push-rke2-bootstrap-image

.PHONY: push-prime-rke2-controlplane-image
push-prime-rke2-controlplane-image: ## Build and push controlplane prime image
	$(MAKE) push-rke2-controlplane-image
